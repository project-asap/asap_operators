 ...
 * 
 * This code is based on code from Google repository, license below applies.
*/
...
#if 1
struct w2v_sort_pred
{
    // bool operator() ( const std::pair<wc_word, size_t> & a,
                      // const std::pair<wc_word, size_t> & b ) const {
    bool operator() ( const vocab_word & a,
                      const vocab_word & b ) const {
        return a.cn > b.cn;
          // || (a.cn == b.cn && strcmp( a.cn, b.cn) > 0);
    }
};
#endif
...
void SaveVocab() {
  ...
  // khere TODO, parallelise with relative file pointers ??
