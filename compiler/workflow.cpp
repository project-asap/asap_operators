...
int main(int argc, char **argv) {
    ...
    const char * input0 = "myInputDirectory";    
    const char * output1 = "tfidf-kmeans.txt";    
    ...
    asap::get_directory_listing( input0, dir_list );
    get_time (end);
    ...
    std::vector<word_map_type> catalog;
    ...
    data_set_type tfidf
	= asap::tfidf<vector_type, std::vector<word_map_type>::const_iterator,
		      word_map_type2>(
